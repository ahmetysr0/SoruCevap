        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_QuestionReports_AspNetUsers_ReportedById",
                        column: x => x.ReportedById,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_QuestionReports_AspNetUsers_ReviewedById",
                        column: x => x.ReviewedById,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id");
                    table.ForeignKey(
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { "10355fee-f91e-4d31-8430-ae635720c020", null, "Admin", "ADMIN" },
                    { "2b695ccd-e679-4e88-b27f-74aaa108a9eb", null, "Kullanici", "KULLANICI" },
                    { "edeaa5b2-512e-4ecc-9d4b-c137298af68b", null, "Personel", "PERSONEL" }
                });

            migrationBuilder.InsertData(
                table: "AspNetUsers",
                columns: new[] { "Id", "AccessFailedCount", "ConcurrencyStamp", "Email", "EmailConfirmed", "FirstName", "LastName", "LockoutEnabled", "LockoutEnd", "NormalizedEmail", "NormalizedUserName", "PasswordHash", "PhoneNumber", "PhoneNumberConfirmed", "SecurityStamp", "TwoFactorEnabled", "UserName" },
                values: new object[] { "7700b7ba-be6b-44f8-a3e0-75c625a4572d", 0, "ce9fd806-279d-4995-a413-74798be5c2f5", "ahmetadmin@example.com", true, "Admin", "User", false, null, "AHMETADMIN@EXAMPLE.COM", "ADMIN", "AQAAAAIAAYagAAAAECw56mXFjXdSbVmwwpuWisQdwLuSSODNI9xQo22Q5rw1HZCfrTD/+gQRWE1mOReJFQ==", null, false, "2b79eb4d-237c-4df2-a53f-951152aba061", false, "admin" });

            migrationBuilder.InsertData(
                table: "AspNetUserRoles",
                columns: new[] { "RoleId", "UserId" },
                values: new object[] { "10355fee-f91e-4d31-8430-ae635720c020", "7700b7ba-be6b-44f8-a3e0-75c625a4572d" });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_QuestionReports_ReportedById",
                table: "QuestionReports",
                column: "ReportedById");

            migrationBuilder.CreateIndex(
                name: "IX_QuestionReports_ReviewedById",
                table: "QuestionReports",
                column: "ReviewedById");
